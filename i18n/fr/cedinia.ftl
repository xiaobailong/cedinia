...
tool_similar_videos = Vidéos similaires (audio)
...
home_similar_images_description = Trouver des photos visuellement similaires
home_empty_files_description = Fichiers de taille nulle
...
home_bad_extensions_description = Fichiers avec une extension invalide
home_same_music_description = Fichiers audio similaires par étiquettes
...
select_highest_res = Sélectionner la résolution la plus élevée
select_lowest_res = Sélectionner la résolution la plus basse
...
permission_body = Pour analyser des fichiers, l'application a besoin d'accéder au stockage de l'appareil. Sans cette autorisation, l'analyse ne sera pas possible.
grant = Accorder
...
settings_common_label = RÉGLAGES COMMUNS
settings_excluded_items = OBJETS EXCLUS (motifs glob, séparés par des virgules)
settings_excluded_items_placeholder = par exemple *.tmp, */.git/*, */node_modules/*
settings_allowed_extensions = EXTENSIONS AUTORISÉES (vide = toutes)
...
settings_duplicates_header = DOUBLONS
settings_check_method_label = MÉTHODE DE COMPARAISON
settings_check_method = Méthode
settings_hash_type_label = Type de HASH
...
settings_similarity_preset = Seuil de similarité
...
settings_image_filter = Filtre de redimensionnement
settings_geometric_invariance = Invariance géométrique
...
settings_big_files_header = PLUS GROS FICHIERS
settings_search_mode = Mode de recherche
settings_file_count = Nombre de fichiers
settings_same_music_header = DOUBLONS MUSICAUX
settings_music_check_method = Mode de comparaison
settings_music_compare_tags_label = ÉTIQUETTES COMPARÉES
settings_music_title = Titre
...
settings_music_approx = Comparaison approximative des étiquettes
settings_temporary_files_header = FICHIERS TEMPORAIRES
settings_temporary_files_extensions_label = EXTENSIONS
settings_temporary_files_extensions_placeholder = par exemple : .tmp, .bak, ~
settings_temporary_files_reset = Revenir aux valeurs par défaut
settings_broken_files_header = FICHIERS CASSÉS
...
settings_broken_files_types_label = TYPES VÉRIFIÉS
settings_broken_audio = Audio
settings_broken_pdf = PDF
settings_broken_archive = Archive
settings_broken_image = Image
settings_broken_font = Police de caractères
settings_broken_markup = Balises (JSON/XML/TOML)
settings_similar_videos_header = VIDÉOS SIMILAIRES (AUDIO)
settings_similar_videos_audio_preset = Préréglage de la similarité audio
settings_similar_videos_audio_preset_desc = Contrôle à quel point l'audio doit concorder
settings_bad_names_header = MAUVAIS NOMS
settings_bad_names_checks_label = VÉRIFICATIONS
settings_bad_names_uppercase_ext = Extension en majuscule
settings_bad_names_emoji = Emoji dans le nom
...
settings_ignore_same_resolution = Ignorer les images ayant la même résolution
# Settings - Appearance section
settings_appearance_label = APPARENCE
settings_dark_theme = Thème sombre
settings_dark_theme_desc = Utiliser un thème de couleur sombre
# Settings - Diagnostics tab
diagnostics_header = DIAGNOSTIC
diagnostics_thumbnails = Cache des miniatures
diagnostics_app_cache = Cache de l'application
diagnostics_refresh = Rafraîchir
diagnostics_clear_thumbnails = Effacer les miniatures
...
diagnostics_export_logs = Exporter les journaux
logs_label = JOURNAUX
logs_export_title = Exporter les journaux
logs_export_saved = Journaux copiés vers :
logs_export_failed = Impossible d'exporter les journaux
...
rename_error_read_file_name = Impossible de lire le nom du fichier
rename_error_read_directory = Impossible de lire le répertoire
and_more_prefix = ... et
and_more_suffix = plus
# Gallery / delete popups
gallery_delete_button = Supprimer
gallery_back = Retour
...
gallery_confirm_delete_msg = Vous êtes sur le point de supprimer { $total_images } images dans { $total_groups } groupes.
gallery_confirm_delete_warning = Tous les éléments sont sélectionnés dans { $unsafe_groups } groupes !
...
similar_videos_group_header = { $count } vidéos similaires
# Rename confirmation
...
option_similarity_high = Haut
option_similarity_medium = Moyen
option_similarity_low = Bas
option_similarity_very_low = V.Bas
...
option_music_method_tags = Étiquettes
option_music_method_audio = Audio
option_min_size_none = Aucun
option_max_size_unlimited = Illimité
option_audio_preset_identical = Identique
option_audio_preset_clip = Extrait inclus dans un fichier plus long
option_audio_preset_similar = Similaire
...
directories_exclude_section_header = EXCLUS
...
directories_check_warning_no_processable = Aucun fichier pouvant être traité - vérifiez vos dossiers inclus/exclus
path_edit_title_include = Ajouter aux inclusions
path_edit_title_exclude = Ajouter aux exclusions
...
path_edit_no_newlines = Les chemins ne peuvent pas contenir de nouvelles lignes - La touche Entrée n'est pas autorisée
ctx_menu_title = Ouvrir
ctx_open_file = Ouvrir l'objet
ctx_open_folder = Ouvrir le dossier parent
dir_open_folder = Ouvrir le dossier
# Compare view
compare_label = Comparer
compare_loading = Chargement des images...
compare_cancelling = Annulation...
compare_computing = Calcul des diffs...
compare_mode_normal = Côté
compare_mode_split = Diviser
