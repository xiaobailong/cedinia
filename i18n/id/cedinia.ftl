...
tool_empty_files = File Kosong
tool_temporary_files = File Sementara
tool_big_files = File Terbesar
tool_broken_files = File Rusak
...
home_empty_files_description = File dengan ukuran nol
home_temp_files_description = File sementara dan file yang disimpan dalam cache
home_big_files_description = File terbesar/terkecil di disk
home_broken_files_description = PDF, audio, gambar, arsip
home_bad_extensions_description = File dengan ekstensi yang tidak valid
home_same_music_description = File audio serupa berdasarkan tag
home_bad_names_description = File dengan karakter yang bermasalah dalam namanya
...
deselect_except_one = Batalkan semua pilihan kecuali satu
# Confirm popup
cancel = Batal
delete = Hapus
rename = Ubah nama
...
ok = OK
# Stopping overlay
stopping_overlay_title = Menghentikan
stopping_overlay_body =
    Menyelesaikan pemindaian saat ini...
    Mohon tunggu.
# Permission popup
permission_title = Akses File
permission_body = Untuk memindai file, aplikasi memerlukan akses ke penyimpanan perangkat. Tanpa izin ini, proses pemindaian tidak akan dapat dilakukan.
grant = Izinkan
no_permission_scan_warning = Tidak dapat mengakses file - berikan izin untuk melakukan pemindaian
...
settings_show_notification = Beri tahu saat pemindaian selesai
...
settings_hash_type_desc = Blake3 adalah pilihan yang direkomendasikan; CRC32 memiliki kemungkinan kecil menghasilkan positif palsu
settings_similar_images_header = GAMBAR SERUPA
settings_similarity_preset = Ambang batas kesamaan
settings_similarity_desc = Sangat Tinggi = hanya yang hampir identik
...
settings_image_filter = Filter pengubah ukuran
...
settings_file_count = Jumlah file
settings_same_music_header = DUPLIKAT MUSIK
settings_music_check_method = Mode perbandingan
settings_music_compare_tags_label = TAG YANG DIBANDINGKAN
...
settings_broken_files_types_label = JENIS YANG DIPERIKSA
...
settings_similar_videos_audio_preset = Preset kesamaan audio
...
diagnostics_thumbnails = Cache thumbnail
diagnostics_app_cache = Cache aplikasi
diagnostics_refresh = Segarkan
diagnostics_clear_thumbnails = Hapus thumbnail
...
diagnostics_collect_test = Uji akses file
diagnostics_collect_test_desc = Periksa berapa banyak file yang dapat diakses
diagnostics_collect_test_run = Jalankan
diagnostics_collect_test_stop = Hentikan
collect_test_cancelled = Dihentikan oleh pengguna
diag_confirm_clear_thumbnails = Hapus semua cache thumbnail?
...
duplicates_group_header = { $count } file x { $per_file } / file = { $total } total
...
# Rename confirmation
confirm_rename_items = Apakah Anda yakin ingin mengubah nama { $n } file yang dipilih?
...
option_audio_preset_clip = Klip dalam video lebih panjang
...
directories_check_label_included = Jalur yang disertakan:
...
directories_check_label_processable = File yang dapat diproses:
directories_check_scanning = Memindai...
directories_check_warning_no_processable = Tidak ditemukan file yang dapat diproses - pastikan folder yang disertakan/dikecualikan sudah benar
