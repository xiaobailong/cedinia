...
tool_similar_videos = Videos similares (Audio)
...
home_similar_videos_description = Encuentra vídeos con audio similar
# Results list
...
settings_geometric_invariance = invariancia geométrica
...
settings_temporary_files_header = ARCHIVOS DE TEMPORARIO
settings_temporary_files_extensions_label = EXTENIONES
settings_temporary_files_extensions_placeholder = ej. .tmp, .bak, ~
settings_temporary_files_reset = Restablecer valores por defecto
...
diagnostics_export_logs = Exportar registros
logs_label = REGISTROS
logs_export_title = Exportar registros
logs_export_saved = Registros copiados a:
logs_export_failed = No se pudo exportar los registros
...
rename_error_read_file_name = No se puede leer el nombre del archivo
rename_error_read_directory = No se puede leer el directorio
and_more_prefix = ...y
and_more_suffix = más
...
similar_videos_group_header = { $count } vídeos similares
# Rename confirmation
...
option_audio_preset_identical = Idéntico
option_audio_preset_clip = Clip más largo
